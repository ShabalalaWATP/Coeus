...
export const CalendarPage = lazy(() => import("../features/profile/CalendarPage"));
...
export const OrganisationAdminPage = lazy(() => import("../features/admin/OrganisationAdminPage"));
...
export const MyWorkPage = lazy(() => import("../features/analyst/MyWorkPage"));
