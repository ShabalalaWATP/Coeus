  ...
  intakeChecklist: [
    {
      key: "description",
      label: "What you need",
      value: "Assess mock port activity.",
      satisfied: true,
    },
    {
      key: "operational_question",
      label: "Question to answer",
      value: "What activity needs attention?",
      satisfied: true,
    },
    { key: "area_or_region", label: "Area or region", value: "Baltic ports", satisfied: true },
    { key: "time_period", label: "Time period", value: null, satisfied: false },
    { key: "priority", label: "Priority", value: null, satisfied: false },
    { key: "requesting_unit", label: "Requesting unit", value: null, satisfied: false },
    { key: "intelligence_disciplines", label: "Disciplines", value: null, satisfied: false },
    {
    ...
    { key: "customer_success_criteria", label: "Success criteria", value: null, satisfied: false },
