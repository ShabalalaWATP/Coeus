"""Hybrid retrieval SQL for Intelligence Store browse queries.

Split from the structured browse statements so each file stays reviewable;
both apply the same access scope predicate before any ranking.
"""
