...
PUBLIC_EVENT_COPY = {
    ...
    "rfi_search_feedback_requested": "Istari asked what was missing from the suggested products.",
    "rfi_search_feedback_recorded": "Search feedback was recorded.",
    "rfi_refined_search_started": "A refined search was started.",
