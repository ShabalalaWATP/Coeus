...
from coeus.domain.outbox import OutboxClaimLost
...
def test_failures_retry_then_dead_letter_at_the_attempt_limit(
    ...
    outbox.mark_failed(message.event_id, worker, "first failure", retry_seconds=1, max_attempts=2)
    ...
    outbox.mark_failed(retried.event_id, worker, "final failure", retry_seconds=1, max_attempts=2)
