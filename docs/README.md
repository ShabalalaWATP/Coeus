...
| [Customer search recovery contract](specs/customer-search-recovery-and-outcomes.md) | Reject-all feedback, refined search, JIOC hand-off and explicit outcomes |
| [ADR 0046](adr/0046-automatic-local-retrieval-rebuilds.md)                          | Automatic local search-library preparation and recovery boundary         |
| [ADR 0047](adr/0047-user-owned-intelligence-store-library.md)                       | Private saved-product references and personal folders                    |
...
| [Documentation Maintenance](development/documentation-maintenance.md)                  | Authority, lifecycle, screenshots, cross-linking and audit rules |
| [Screenshot Inventory](images/README.md)                                               | Current capture date, routes, accounts and image purpose         |
...
Screenshots embedded in the User Guide live in the
[screenshot inventory](images/README.md). They use synthetic accounts and
content. Authenticated workspaces display one persistent **Synthetic exercise**
indicator; public sign-in and access-request screens contain no app data.

- Use UK English.
- Keep every example synthetic and public-repository-safe.
- Keep the root README concise and link operational detail here.
- Do not split documentation merely to satisfy the 350-line source-file limit;
  Markdown is exempt and should instead be organised for reader navigation.
