...
| Mixed, negated or weak route language is treated as a confident automatic route. | Routing uses explicit evidence outcomes rather than presenting fixed keyword scores as probability. Conflicting eligibility, negation, restrictions, missing evidence and unsupported scope require clarification or human JIOC review. |
