...
- Deterministic local semantic scoring does not represent production embedding
  quality. Database-backed full-text and pgvector adapters must be reviewed when
