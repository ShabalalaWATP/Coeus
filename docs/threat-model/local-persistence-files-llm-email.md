...
| Retired workspace payloads in older local state break startup or restore removed authorisation paths. | The codec drops retired workspace records and `project:*` permissions during decode. Unknown non-retired payloads still fail closed. |
